...
namespace sot
{
    ...
    public:
         ...
         */
        GeneticAlgorithm(std::shared_ptr<Problem> &data, int numIndividuals, int numGenerations, int numThreads) : GeneticAlgorithm(data, numIndividuals, numGenerations)
        {
         ...
         */
        GeneticAlgorithm(std::shared_ptr<Problem> &data, std::shared_ptr<ExpDesign> &expDes,
                         int numIndividuals, int numGenerations, int numThreads) : GeneticAlgorithm(data, expDes, numIndividuals, numGenerations)
        {
            mNumThreads = numThreads;
        }
